package br.com.marcelkaneko.notepadAPI.component;

import br.com.marcelkaneko.notepadAPI.model.Nota;
import br.com.marcelkaneko.notepadAPI.repository.NotaRepository;
...
public class NotaComponent {
    ...
    public void apagar (String titulo) {
        Nota nota;
        List<Nota> notas = notaRepository.findByTitulo(titulo);
        if(!notas.isEmpty()) notaRepository.delete(notas.get(0));
    }
